    ...
    <>
      ...
      >
        {sections.map(({ text, img, parentDiv }, i) => (
          <div
            key={i}
            className={`mb-32 mt-20 items-center justify-center overflow-hidden rounded-3xl xl:flex xl:h-[30rem] ${parentDiv}`}
          >
            <img
              src={img}
              alt=""
              className="h-[40rem] w-full md:h-auto xl:w-auto"
            />
            <div
            ...
            >
              ...
              <p className="2xl:text-auto mb-6 text-xl">{text.p1}</p>
              <p>{text.p2 && text.p2}</p>
            </div>
          </div>
        ))}
